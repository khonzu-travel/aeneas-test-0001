...
const STAGE_CLASS: Record<Stage, string> = {
  ...
  analysis: styles.stageAnalysis,
  scheduling: styles.stageScheduling,
  build: styles.stageBuild,
  release: styles.stageRelease,
};

/** map an item state to an LED color class */
...
export function FeatureCard({ feature }: { feature: Feature }) {
  ...
  return (
    <article
      className={clsx(styles.card, 'brass-frame', 'rivets', blocked && styles.blockedCard)}
    >
